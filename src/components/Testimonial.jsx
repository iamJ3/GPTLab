...
const Testimonial = () => {
  ...
  const CreateCard = ({ card }) => (
    <div className="relative group p-6 rounded-2xl mx-4 w-80 shrink-0 
      ...
      <div className="relative z-10 flex gap-3 mb-4">
        <div className="relative">
          <img className="w-12 h-12 rounded-full border-2 border-gray-600 group-hover:border-green-500/50 
        ...
        <div className="flex flex-col justify-center">
          <div className="flex items-center gap-2">
            <p className="text-white font-semibold text-sm group-hover:text-green-300 
                                    transition-colors duration-300">
              {card.name}
            </p>
            <svg className="w-4 h-4 text-blue-400" viewBox="0 0 12 12" fill="none">
      ...
      {/* Testimonial Text */}
      <p className="relative z-10 text-gray-300 text-sm leading-relaxed mb-4 group-hover:text-gray-200 
                         transition-colors duration-300">
        "{card.testimonial}"
      </p>
  ...
  return (
    <section className="relative min-h-screen bg-black py-20 overflow-hidden">
      ...
      {/* Header Section */}
      <div className="relative z-10 text-center mb-16 px-4 sm:px-8 lg:px-16 xl:px-24">
      ...
      <div className="relative z-10">
        ...
        <div className="marquee-row w-full overflow-hidden relative mb-8">
          <div className="absolute left-0 top-0 h-full w-20 md:w-32 z-20 pointer-events-none 

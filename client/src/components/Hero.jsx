        ...
        <section className="relative pt-4 w-full min-h-screen overflow-hidden bg-black">
            ...
            <div className="relative z-20 flex flex-col justify-center items-center min-h-screen px-4 sm:px-8 lg:px-16 xl:px-24 text-center">
                ...
                <div className='mb-12 relative mt-10 max-w-5xl mx-auto'>
                    ...
                    <p className='text-gray-300 text-lg sm:text-xl lg:text-2xl leading-relaxed max-w-3xl mx-auto 
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-center justify-center mb-12">
                    ...
                    <button
                        ...
                        className="group relative flex items-center gap-3 rounded-full text-lg font-semibold text-black 
                                 bg-gradient-to-r from-green-400 to-emerald-500 px-10 py-4 
                    ...
                    >
                        <svg className="w-5 h-5 group-hover:rotate-12 transition-transform duration-200"
